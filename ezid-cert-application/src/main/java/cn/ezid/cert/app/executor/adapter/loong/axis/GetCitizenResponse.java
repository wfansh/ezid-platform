...
public class GetCitizenResponse extends cn.ezid.cert.app.executor.adapter.loong.axis.ResponseBase implements
		java.io.Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 7354152823831518504L;
	private cn.ezid.cert.app.executor.adapter.loong.axis.IdentifierData identifier;

	public GetCitizenResponse() {
	}

	public GetCitizenResponse(cn.ezid.cert.app.executor.adapter.loong.axis.ResponseCode responseCode,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof GetCitizenResponse))
			return false;
