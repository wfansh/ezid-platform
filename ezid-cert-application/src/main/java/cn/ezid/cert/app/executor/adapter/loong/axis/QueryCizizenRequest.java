...
public class QueryCizizenRequest extends cn.ezid.cert.app.executor.adapter.loong.axis.PagedRequest implements
		java.io.Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = -4948992817491354417L;
	...
	public QueryCizizenRequest(int startIndex, int endIndex, java.lang.String dateStart, java.lang.String citizId,
			java.lang.String name, java.lang.String dateEnd, java.lang.String operatorName, java.lang.String result) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof QueryCizizenRequest))
			return false;
		...
		_equals = super.equals(obj)
				&& ((this.dateStart == null && other.getDateStart() == null) || (this.dateStart != null && this.dateStart
						.equals(other.getDateStart())))
				&& ((this.citizId == null && other.getCitizId() == null) || (this.citizId != null && this.citizId
						.equals(other.getCitizId())))
				&& ((this.name == null && other.getName() == null) || (this.name != null && this.name.equals(other
						.getName())))
				&& ((this.dateEnd == null && other.getDateEnd() == null) || (this.dateEnd != null && this.dateEnd
						.equals(other.getDateEnd())))
				&& ((this.operatorName == null && other.getOperatorName() == null) || (this.operatorName != null && this.operatorName
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			QueryCizizenRequest.class, true);
