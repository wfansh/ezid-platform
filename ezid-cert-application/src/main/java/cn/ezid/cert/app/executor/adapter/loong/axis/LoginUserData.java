...
public class LoginUserData implements java.io.Serializable {
	...
	public LoginUserData(String loginName, String password, String uniqueId) {
		this.loginName = loginName;
		this.password = password;
		this.uniqueId = uniqueId;
	}
	
	public LoginUserData(java.lang.String loginName, java.lang.String password, java.lang.String uniqueId,
			java.lang.String client, java.lang.String userId, boolean shareSuper, boolean isAdministrator,
			boolean firstLogin) {
		this.loginName = loginName;
		this.password = password;
		this.uniqueId = uniqueId;
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = true
				...
				&& ((this.uniqueId == null && other.getUniqueId() == null) || (this.uniqueId != null && this.uniqueId
						.equals(other.getUniqueId())))
				&& ((this.client == null && other.getClient() == null) || (this.client != null && this.client
						.equals(other.getClient())))
				&& ((this.userId == null && other.getUserId() == null) || (this.userId != null && this.userId
						.equals(other.getUserId()))) && this.shareSuper == other.isShareSuper()
				&& this.isAdministrator == other.isIsAdministrator() && this.firstLogin == other.isFirstLogin();
		__equalsCalc = null;
		return _equals;
	}
