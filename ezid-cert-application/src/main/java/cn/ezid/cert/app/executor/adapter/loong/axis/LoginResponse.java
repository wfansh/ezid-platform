...
public class LoginResponse implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7519735325384685458L;

	private cn.ezid.cert.app.executor.adapter.loong.axis.LoginResposeCode responseCode;

	private cn.ezid.cert.app.executor.adapter.loong.axis.LoginUserData userData;
	...
	public LoginResponse(cn.ezid.cert.app.executor.adapter.loong.axis.LoginResposeCode responseCode,
			cn.ezid.cert.app.executor.adapter.loong.axis.LoginUserData userData, java.lang.String serversXmlData) {
	 ...
	 * @return responseCode
	 */
	public cn.ezid.cert.app.executor.adapter.loong.axis.LoginResposeCode getResponseCode() {
		return responseCode;
	}
	 ...
	 * @param responseCode
	 */
	public void setResponseCode(cn.ezid.cert.app.executor.adapter.loong.axis.LoginResposeCode responseCode) {
		this.responseCode = responseCode;
	}
	 ...
	 * @return userData
	 */
	public cn.ezid.cert.app.executor.adapter.loong.axis.LoginUserData getUserData() {
		return userData;
	}
	 ...
	 * @param userData
	 */
	public void setUserData(cn.ezid.cert.app.executor.adapter.loong.axis.LoginUserData userData) {
		this.userData = userData;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		boolean _equals;
		_equals = true
				&& ((this.responseCode == null && other.getResponseCode() == null) || (this.responseCode != null && this.responseCode
				...
				&& ((this.serversXmlData == null && other.getServersXmlData() == null) || (this.serversXmlData != null && this.serversXmlData
						.equals(other.getServersXmlData())));
		__equalsCalc = null;
		return _equals;
	}
