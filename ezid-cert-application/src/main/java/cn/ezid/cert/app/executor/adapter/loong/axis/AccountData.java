...
public class AccountData implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6487998630426880939L;
	...
	public AccountData(java.lang.String userId, java.lang.String clientId, java.lang.String loginName,
			java.lang.String password, java.lang.String realName, java.lang.String branch,
			java.lang.String userDescription, java.lang.String userType, int status, java.math.BigDecimal balance,
			boolean shareSuper, java.lang.String expirationDate, java.lang.String creatorId,
			java.lang.String lastLoginTime, int loginTimes) {
		this.userId = userId;
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = true
				...
				&& ((this.loginName == null && other.getLoginName() == null) || (this.loginName != null && this.loginName
						.equals(other.getLoginName())))
				&& ((this.password == null && other.getPassword() == null) || (this.password != null && this.password
						.equals(other.getPassword())))
				&& ((this.realName == null && other.getRealName() == null) || (this.realName != null && this.realName
						.equals(other.getRealName())))
				&& ((this.branch == null && other.getBranch() == null) || (this.branch != null && this.branch
						.equals(other.getBranch())))
				&& ((this.userDescription == null && other.getUserDescription() == null) || (this.userDescription != null && this.userDescription
						.equals(other.getUserDescription())))
				&& ((this.userType == null && other.getUserType() == null) || (this.userType != null && this.userType
						.equals(other.getUserType())))
				&& this.status == other.getStatus()
				&& ((this.balance == null && other.getBalance() == null) || (this.balance != null && this.balance
						.equals(other.getBalance())))
				&& this.shareSuper == other.isShareSuper()
				&& ((this.expirationDate == null && other.getExpirationDate() == null) || (this.expirationDate != null && this.expirationDate
				...
				&& ((this.lastLoginTime == null && other.getLastLoginTime() == null) || (this.lastLoginTime != null && this.lastLoginTime
						.equals(other.getLastLoginTime()))) && this.loginTimes == other.getLoginTimes();
		__equalsCalc = null;
		return _equals;
	}
