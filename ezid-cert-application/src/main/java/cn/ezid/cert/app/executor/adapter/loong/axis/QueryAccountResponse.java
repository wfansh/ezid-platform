...
public class QueryAccountResponse extends cn.ezid.cert.app.executor.adapter.loong.axis.ResponseBase implements
		java.io.Serializable {
	private cn.ezid.cert.app.executor.adapter.loong.axis.AccountData[] accounts;

	public QueryAccountResponse() {
	}

	public QueryAccountResponse(cn.ezid.cert.app.executor.adapter.loong.axis.ResponseCode responseCode,
			cn.ezid.cert.app.executor.adapter.loong.axis.AccountData[] accounts) {
		super(responseCode);
	 ...
	 * @return accounts
	 */
	public cn.ezid.cert.app.executor.adapter.loong.axis.AccountData[] getAccounts() {
		return accounts;
	}
	 ...
	 * @param accounts
	 */
	public void setAccounts(cn.ezid.cert.app.executor.adapter.loong.axis.AccountData[] accounts) {
		this.accounts = accounts;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = super.equals(obj)
				&& ((this.accounts == null && other.getAccounts() == null) || (this.accounts != null && java.util.Arrays
						.equals(this.accounts, other.getAccounts())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getAccounts() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getAccounts()); i++) {
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			QueryAccountResponse.class, true);
