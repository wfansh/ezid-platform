...
public class QueryFeeResponse extends cn.ezid.cert.app.executor.adapter.loong.axis.ResponseBase implements
		java.io.Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1503613832455088751L;
	...
	public QueryFeeResponse(cn.ezid.cert.app.executor.adapter.loong.axis.ResponseCode responseCode,
			int totalQueryCount, int remainQueryCount, boolean shareSuper) {
		super(responseCode);
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof QueryFeeResponse))
			return false;
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = super.equals(obj) && this.totalQueryCount == other.getTotalQueryCount()
				&& this.remainQueryCount == other.getRemainQueryCount() && this.shareSuper == other.isShareSuper();
		__equalsCalc = null;
		return _equals;
	}
