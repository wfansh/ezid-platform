...
public class HistoryData implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3983029576700811571L;
	...
	public HistoryData(java.lang.String seq, java.lang.String time,
			cn.ezid.cert.app.executor.adapter.loong.axis.IdentifierData identifier, java.lang.String importType,
			int isHistory, java.lang.String operationId, java.lang.String operatorName) {
		this.seq = seq;
		this.time = time;
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = true
				&& ((this.seq == null && other.getSeq() == null) || (this.seq != null && this.seq
						.equals(other.getSeq())))
				&& ((this.time == null && other.getTime() == null) || (this.time != null && this.time.equals(other
						.getTime())))
				&& ((this.identifier == null && other.getIdentifier() == null) || (this.identifier != null && this.identifier
						.equals(other.getIdentifier())))
				&& ((this.importType == null && other.getImportType() == null) || (this.importType != null && this.importType
						.equals(other.getImportType())))
				&& this.isHistory == other.getIsHistory()
				&& ((this.operationId == null && other.getOperationId() == null) || (this.operationId != null && this.operationId
