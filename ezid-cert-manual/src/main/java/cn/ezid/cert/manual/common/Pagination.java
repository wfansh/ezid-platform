...
public class Pagination<T> {
	 ...
	 *            本页数据对象列表
	 */
	public Pagination(int pageNo, int pageSize, long count, List<T> list) {
		this.setCount(count);
	...
	public String toString() {
		...
		if (pageSize == 10) {
			sb.append("<select onchange=\"toPage()\" aria-controls=\"DataTables_Table_0\" "
					+ "name=\"DataTables_Table_0_length\" id=\"viewPageSize\" size=\"1\">"
		...
		if (pageSize == 50) {
			sb.append("<select onchange=\"toPage()\" aria-controls=\"DataTables_Table_0\" "
					+ "name=\"DataTables_Table_0_length\" id=\"viewPageSize\" size=\"1\">"
					+ "<option  value=\"10\">10</option>" + "<option selected value=\"50\">50</option>"
					+ "<option value=\"100\">100</option>" + "</select>");
		}
		if (pageSize == 100) {
			sb.append("<select onchange=\"toPage()\" aria-controls=\"DataTables_Table_0\" "
					...
					+ "<option  selected value=\"100\">100</option>" + "</select>");
		}

		sb.append("<div class=\"dataTables_info\" id=\"DataTables_Table_0_info\">\n");
		...
		if (pageNo == first) {// 如果是首页
			...
			sb.append("<li><a class=\"prev\" href=\"javascript:\" onclick=\"" + funcName + "(" + prev + "," + pageSize
					+ ");\">&#171; 上一页</a></li>\n");
		}
		...
		if (pageNo == last) {
			sb.append("<li class=\"disabled next\"><a href=\"javascript:\">下一页 &#187;</a></li>\n");
		} else {
			sb.append("<li><a class=\"next\" href=\"javascript:\" onclick=\"" + funcName + "(" + next + "," + pageSize
					+ ");\">" + "下一页 &#187;</a></li>\n");
		}
