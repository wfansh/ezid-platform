						...
						<div id="photo-tab" class="tab-pane fade active in">
							...
							<div class="feed-content">
								...
								<div class="row">
									...
									<c:if test="${not empty task.passportPrintFilePath}">
										<div class="col-md-3" style="margin-bottom:10px">
											<div class="thumbnail">
												<div class="thumbnail-view" style="text-align:center;margin:0 auto;">
													<a href="<c:url value="/res/${task.passportPrintFilePath}"/>" class="thumbnail-view-hover ui-lightbox"></a>
						            				<img src="<c:url value="/res/${task.passportPrintFilePath}"/>" style="width: 100%" alt="照片" onerror="this.src='<c:url value="/img/default_photo.jpg'" />" />
						            				<span>护照</span>
						        				</div>
					          				</div>			
										</div> <!-- /.col -->
