...
import org.activiti.rest.service.api.history.HistoricProcessInstanceVariableCollectionResource;
import org.activiti.rest.service.api.history.HistoricProcessInstanceVariableDataResource;
import org.activiti.rest.service.api.history.HistoricProcessInstanceVariableResource;
...
import org.activiti.rest.service.api.history.HistoricTaskInstanceVariableCollectionResource;
import org.activiti.rest.service.api.history.HistoricTaskInstanceVariableDataResource;
import org.activiti.rest.service.api.history.HistoricTaskInstanceVariableResource;
...
public class RestServicesInit {
  ...
  public static void attachResources(Router router) {
    ...
    router.attach("/history/historic-process-instances/{processInstanceId}/variables", HistoricProcessInstanceVariableCollectionResource.class);
    router.attach("/history/historic-process-instances/{processInstanceId}/variables/{variableName}", HistoricProcessInstanceVariableResource.class);
    ...
    router.attach("/history/historic-task-instances/{taskId}/variables", HistoricTaskInstanceVariableCollectionResource.class);
    router.attach("/history/historic-task-instances/{taskId}/variables/{variableName}",  HistoricTaskInstanceVariableResource.class);
